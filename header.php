...
<div id="page" class="hfeed site">
	<div class="container header-area">
		...
		<header id="masthead" class="site-header col-sm-12" role="banner">
			...
			<?php if( get_header_image() != '' ) : ?>
				<div class="site-branding col-md-6 col-sm-8 col-xs-12">
				...
				<div class="hidden col-sm-4 flexParent">
					<h4 class="site-description flexChild"><?php bloginfo( 'description' ); ?></h4>
				</div>
	...
	<?php if (is_page('home')): ?>
		...
		<?php get_template_part( 'post_content/homeImg' ); ?>
